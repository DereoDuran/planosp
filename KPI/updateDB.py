...
def drsInfo():
    ...
    drs_info['DRS 11 Presidente Prudente'] = ['Nantes', 'Ouro Verde', 'Alfredo Marcondes', 'Anhumas', 'Caiabu', 'Caiuá', 'Dracena', 'Emilianópolis', 'Estrela do Norte', 'Euclides da Cunha Paulista', 'Flora Rica', 'Iepê', 'Indiana', 'Irapuru', 'João Ramalho', 'Junqueirópolis', 'Marabá Paulista', 'Martinópolis', 'Mirante do Paranapanema', 'Monte Castelo', 'Narandiba', 'Nova Guataporanga', 'Panorama', 'Paulicéia', 'Piquerobi', 'Pirapozinho', 'Presidente Bernardes', 'Presidente Epitácio', 'Presidente Prudente', 'Presidente Venceslau', 'Quatá', 'Rancharia', 'Regente Feijó', 'Ribeirão dos Índios', 'Rosana', 'Sandovalina', 'Santo Anastácio', 'Santo Expedito', "São João do Pau d'Alho", 'Taciba', 'Tarabai', 'Teodoro Sampaio', 'Tupi Paulista', 'Álvares Machado']
